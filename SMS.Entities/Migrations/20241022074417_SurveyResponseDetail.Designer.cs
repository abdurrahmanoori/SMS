...
namespace SMS.Entities.Migrations
{
    ...
    [Migration("20241022074417_SurveyResponseDetail")]
    partial class SurveyResponseDetail
    {
            ...
            modelBuilder.Entity("SMS.Entities.SurveyResponse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SurveyResponseID = 1,
                            RespondentID = 1,
                            ResponseDate = new DateTime(2024, 10, 22, 7, 44, 17, 344, DateTimeKind.Utc).AddTicks(4973),
                            SurveyInstanceID = 1
                        },
                        new
                        {
                            SurveyResponseID = 2,
                            RespondentID = 2,
                            ResponseDate = new DateTime(2024, 10, 21, 7, 44, 17, 344, DateTimeKind.Utc).AddTicks(4974),
                            SurveyInstanceID = 2
                        },
                        new
                        {
                            SurveyResponseID = 3,
                            RespondentID = 3,
                            ResponseDate = new DateTime(2024, 10, 20, 7, 44, 17, 344, DateTimeKind.Utc).AddTicks(4978),
                            SurveyInstanceID = 3
                        });
                });
